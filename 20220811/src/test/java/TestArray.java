...
public class TestArray {
    ...
    @Test
    public void testdataForArrayCheckOperation() {
        Assertions.assertThrows(RuntimeException.class, () -> checkArray.getAllAfterLastNumber(badArray, number));
    }
}
